...
library(MSD)
rainData = raster
precipData = terra::rast(rainData, subds = "pr")

#Filter the infile data with a bartlett window of 31. Repeat 2x
filteredData1 = terra::app(precipData, msdFilter, window=31)
filteredData = terra::app(filteredData1, msdFilter, window=31)
...
duration <- terra::app(filteredData, msdStats, dates, fcn="duration")
intensity <- terra::app(filteredData, msdStats, dates, fcn="intensity")
firstMax <- terra::app(filteredData, msdStats, dates, fcn="firstMax")
secondMax <- terra::app(filteredData, msdStats, dates, fcn="secondMax")
minimum <- terra::app(filteredData, msdStats, dates, fcn="minimum")
mindex <- terra::app(filteredData, msdStats, dates, fcn="mindex")
