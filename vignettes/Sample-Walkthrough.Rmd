...
durationValue <- apply(filterTS, MARGIN = 2, FUN = msdStats, keyDatesTS, fcn="duration")
intensityValue <- apply(filterTS, MARGIN = 2, FUN = msdStats, keyDatesTS, fcn="intensity")
