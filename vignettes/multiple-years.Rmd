...
```{r}
#!! INCOMPLETE
# We need the "egg" package to arrange our plots
#library(egg)
#plotList = ggplot()
#startYear = year(x[1,1])
#endYear = year(x[length(x),1])
#lengthYears = (endYear-startYear) + 1
#for(i in startYear:endYear){
#    plot = msdGraph(x, i)
#    plotList = list(plotList, plot)
#}
#combinedPlots = plotList[-1]
```
