...
finalPlot = ggplot(data = combinedPlotData, mapping = aes(x=Date,y=Precip))+
  theme_bw()+annotate("rect", xmin=combinedPlotData[1,1], 
  xmax=combinedPlotData[nrow(combinedPlotData),1], ymin=0, 
  ymax=(max(combinedPlotData$Precip, na.rm=TRUE)+2),
  fill=combinedPlots$Color, alpha=0.5)+
  xlab("")+
