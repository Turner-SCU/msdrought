...
critDates = msdDates(formattedDates)
...
suppressWarnings({
intensityPlots <- terra::app(filtered, msdStats, critDates, fcn="intensity")
durationPlots <- terra::app(filtered, msdStats, critDates, fcn="duration")
})
```

The "intensityPlots" and "durationPlots" rasters contain the intensity and duration values for every geographical location for each of the 5 years of data contained in the original dataset. Now that we have all the intensity and duration values, we will extract a single point's data from the new rasters.
